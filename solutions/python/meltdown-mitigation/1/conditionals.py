...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if efficency >= 80:
        return "green"
    elif efficency < 80 and efficency >= 60:
        return "orange"
    elif efficency < 60 and efficency >= 30:
        return "red"
    else:
        return "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if 0.9 * threshold > calculation:
        return "LOW"
    elif (calculation > 0.9 * threshold and calculation <= 1.1 * threshold):
        return "NORMAL"
    else:
        return "DANGER"
